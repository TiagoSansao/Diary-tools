    ...
    <View style={styles.container}>
      <View style={styles.gameContainer}>
        <View style={styles.playerOptions}>
          <Text style={styles.computerScore}>Computer score: {playerScore2}</Text>
          <View style={styles.playerOption}>
            <FontAwesome5 name={computerChoiceVisual === null ? 'question' : computerChoiceVisual} size={50} color="#ecf0f1" />
          </View>
          <View style={styles.playerOption}>
            <FontAwesome5 name={computerChoiceVisual === null ? 'question' : computerChoiceVisual} size={50} color="#ecf0f1" />
          </View>
        ...
        <View style={styles.playerOptions}>
          ...
          <TouchableOpacity style={styles.playerOption} onPress={() => playerVsComputerMatch('rock')} disabled={gameStatus !== 'Faça sua escolha' ? true : false} >
            <FontAwesome5 name="hand-rock" size={50} color="#ecf0f1" />
            <Text style={styles.label}>Pedra</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.playerOption} onPress={() => playerVsComputerMatch('paper')} disabled={gameStatus !== 'Faça sua escolha' ? true : false} >
            <FontAwesome5 name="hand-paper" size={50} color="#ecf0f1" />
            <Text style={styles.label}>Papel</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.playerOption} onPress={() => playerVsComputerMatch('scissor')} disabled={gameStatus !== 'Faça sua escolha' ? true : false} >
